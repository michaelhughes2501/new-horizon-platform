...
export default tseslint.config(
  ...
  { ignores: ['dist', 'node_modules'] },
  {
    ...
    rules: {
      ...
      //
      // NOTE: don't spread `reactHooks.configs.recommended.rules` here —
      // that preset now includes the compiler-oriented rules, which would
      // silently re-enable everything this comment says we're excluding.
